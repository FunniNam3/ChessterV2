def Black_knight(position, board, location):
    ...
    if(row>1):
        ...
        if(column>0):
            ...
            # Checks if the square up left has a white piece
                
            if(board[row-2][column-1].isupper()):
        ...
        if(column<7):
            ...
            # Checks if the square up right has a white piece
            if(board[row-2][column+1].isupper()):
                # Sets the location as a valid spot to take
                possible_moves[row-2][column+1] = 't'
    ...
    if(row<7):
        ...
        if(column>0):
            ...
            # Checks if the square down left has a white piece
            if(board[row+2][column-1].isupper()):
                # Sets the location as a valid spot to take
                possible_moves[row+2][column-1] = 't'
        ...
        if(column<7):
            ...
            # Checks if the square down right has a white piece
            if(board[row+2][column+1].isupper()):
                # Sets the location as a valid spot to take
                possible_moves[row+2][column+1] = 't'
    ...
    if((column)<6):
        ...
        if(row>0):
            ...
            # Checks if the square right up has a white piece
            if(board[row-1][column+2].isupper()):
                # Sets the location as a valid spot to take
        ...
        if(row<7):
            ...
            if(board[row+1][column+2]=='.'):
                # Sets the location as a valid spot to move to
                possible_moves[row+1][column+2] = 'm'
            # Checks if the square right down has a white piece
            if(board[row+1][column+2].isupper()):
                # Sets the location as a valid spot to take
                possible_moves[row+1][column+2] = 't'
    ...
    if((column)>1):
        ...
        if(row>0):
            ...
            if(board[row-1][column-2]=='.'):
                # Sets the location as a valid spot to move to
                possible_moves[row-1][column-2] = 'm'
            # Checks if the square left up has a white piece
            if(board[row-1][column-2].isupper()):
                # Sets the location as a valid spot to take
                possible_moves[row-1][column-2] = 't'
        ...
        if(row<7):
            ...
            if(board[row+1][column-2]=='.'):
                # Sets the location as a valid spot to move to
                possible_moves[row+1][column-2] = 'm'
            # Checks if the square left down has a white piece
            if(board[row+1][column-2].isupper()):
                # Sets the location as a valid spot to take
                possible_moves[row+1][column-2] = 't'
