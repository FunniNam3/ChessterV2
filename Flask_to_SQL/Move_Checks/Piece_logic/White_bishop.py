def White_bishop(position, board, location):
    ...
    if row<=column:
        for x in range(row-1,-1,-1):
            ...
            if board[x][column+(row-x)]=='.':
                ...
                if board[x][column+(row-x)].islower():
        ...
        for x in range(column+1,8):
            ...
            if board[row+(x-column)][x]=='.':
                ...
                if board[row+(x-column)][x].islower():
        ...
        for x in range(column-1,-1,-1):
            ...
            if board[row+(column-x)][x]=='.':
                ...
                if board[row+(column-x)][x].islower():
        ...
        for x in range(row+1,8):
            ...
            if board[x][column+(x-row)]=='.':
                ...
                if board[x][column+(x-row)].islower():
